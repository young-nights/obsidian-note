...
------------------------------------------------------------------------
7.按提示输入文件保存路径（默认路径为 ~/.ssh/id_ed25519）
  按提示输入密码（可以留空）
------------------------------------------------------------------------
8.查看生成的公钥内容
...
(1) git add .		// 将所有变动文件添加到缓冲区
(2) git status		// 查看缓冲区状态
(3) git remote add origin git@gitee.com:mr_nights/esp32-item.git 
