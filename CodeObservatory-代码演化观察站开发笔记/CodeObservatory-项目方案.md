...
## 概述
独立跨平台桌面应用，专注解决多 Agent 代码变更的可视化追踪痛点。UI 设计借鉴 Cursor / Windsurf / Linear 现代风格：深色主题、左侧边栏导航、玻璃态材质。
...
| v0.6 | 2026-05-26 | 宇宙星河文件关系图谱：Rust scan_directory 递归扫描 + Graph 页面重构（深空背景、星云色谱、发光节点、星座连线） |
