...
```bash
# <font size=4>点击鼠标右键，打开gitbash，运行以下代码下载官网的v1.5.0版本代码</font>
# <font size=4>--depth 1 表示只下载该 Tag 的快照，不带其他历史，体积最小</font>
...
> [!info]
> ℹ️ IndexTTS 目前有两个版本，分别为 IndexTTS 和 IndexTTS-1.5  ，**1.5版本显著提升了模型的稳定性和英语语言性能**。根据需要选择一个版本下载即可
